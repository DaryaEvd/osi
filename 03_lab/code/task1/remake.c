...
int main(int argc, char **argv) {
  ...
  char *endDirPath = calloc(lengthStartDir + 1 + 1, sizeof(char));
  ...
  char *beforeLastDir =
      calloc(lengthStartDir - amountSymbLastDir + 1 + 1, sizeof(char));
  ...
  char *nameReversedLastDir =
      calloc(amountSymbLastDir + 1 + 1, sizeof(char));
    ...
    while ((entry = readdir(d)) != NULL) {
      ...
      if (entry->d_type == DT_REG) {
        ...
        char *reversedFileNameCurr =
            calloc(lengthRegFileCurr + 1 + 1, sizeof(char));
        ...
        char *outputFilePath =
            calloc(lengthStartDir + lengthRegFileCurr + 1 + 1, sizeof(char));
